    ...
    return (
        <>
            ...
            <div id="content" className="">
                <ol className="breadcrumb hidden-print float-xl-right">
                ...
                <div className="invoice">
                    <div className="invoice-company">
                        <span className="pull-right hidden-print">
                            <a href="javascript:;" className="btn btn-sm btn-white m-b-10"><i className="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i> Export as PDF</a>
                            <a href="javascript:;" onClick={() => window.print()} className="btn btn-sm btn-white m-b-10"><i className="fa fa-print t-plus-1 fa-fw fa-lg"></i> Print</a>
                        </span>
                        Company Name, Inc
                    </div>
